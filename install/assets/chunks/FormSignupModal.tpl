 ...
 * FormSignupModal
 *
 * weblogin signup tpl for ModalX
 *
 * @category	chunk
   	...
   	<div class="form-group col-md-6">
		...
		<input type="password" name="confirmpassword" id="confirmpassword" class="form-control" placeholder="Confirm password"/>
          ...
          <div class="form-group col-md-6">
            ...
            <p><a href="[+action+]"><img align="top" src="[(site_manager_url)]includes/veriword.php" width="220" height="60" alt="If you have trouble reading the code, click on the code itself to generate a new random code." style="border: 1px solid #039" /></a></p>
        <label>
	</div>

	<div class="form-group col-md-6">
		<label>Please repeat</label>  
